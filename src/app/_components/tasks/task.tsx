...
import { Calendar, ListTodo, Clock, Trash } from "lucide-react";
      ...
      <div className="px-4 py-5 sm:p-6">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center mb-2">
            ...
            <Trash className="" onClick={handleDelete}/>
          </div>
        <div className="mt-3 flex items-center text-sm text-gray-500">
         <ListTodo className={`mr-1.5 h-5 w-5 flex-shrink-0 ${completed ? 'text-green-500' : 'text-gray-400'}`} />
